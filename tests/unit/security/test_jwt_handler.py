...
class TestDecoding:
    ...
    def test_expired_tokens(self, token_type: TokenType, expected_lifetime: int):
        fixed_dt = datetime(2025, 1, 1, 12, 0, 0, tzinfo=timezone.utc)
    ...
    def test_token_wrong_signature(self):
